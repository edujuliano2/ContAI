...
async function middleware(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://mnnkkxsvarhtieevmzfi.supabase.co") || '', ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1ubmtreHN2YXJodGllZXZtemZpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTc4MTk4NjUsImV4cCI6MjA3MzM5NTg2NX0.0l73c14mD9LQ9TPmEDglHTHJksKor4dMfS19xskbxWg") || '', {
        cookies: {
            getAll () {
    ...
    const isProtectedRoute = request.nextUrl.pathname.startsWith('/dashboard') || request.nextUrl.pathname.startsWith('/lancamentos') || request.nextUrl.pathname.startsWith('/relatorios');
